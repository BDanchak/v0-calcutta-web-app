...
const tournamentTeams: Record<string, TournamentTeam[]> = {
  ...
  // Added Survivor Season 50 cast - all 24 returning all-star contestants per user request
  "survivor-50": [
    { id: 1, name: "Jenna Lewis-Dougherty", seed: 1, region: "Old School" },
    { id: 2, name: "Colby Donaldson", seed: 2, region: "Old School" },
    { id: 3, name: "Stephenie LaGrossa Kendrick", seed: 3, region: "Old School" },
    { id: 4, name: "Cirie Fields", seed: 4, region: "Old School" },
    { id: 5, name: "Ozzy Lusth", seed: 5, region: "Old School" },
    { id: 6, name: 'Benjamin "Coach" Wade', seed: 6, region: "Old School" },
    { id: 7, name: "Aubry Bracco", seed: 7, region: "Old School" },
    { id: 8, name: "Chrissy Hofbeck", seed: 8, region: "Old School" },
    { id: 9, name: "Christian Hubicki", seed: 9, region: "Old School" },
    { id: 10, name: "Angelina Keeley", seed: 10, region: "Old School" },
    { id: 11, name: "Mike White", seed: 11, region: "Old School" },
    { id: 12, name: "Rick Devens", seed: 12, region: "Old School" },
    { id: 13, name: "Jonathan Young", seed: 1, region: "New School" },
    { id: 14, name: "Emily Flippen", seed: 2, region: "New School" },
    { id: 15, name: "Dee Valladares", seed: 3, region: "New School" },
    { id: 16, name: 'Quintavius "Q" Burdette', seed: 4, region: "New School" },
    { id: 17, name: "Charlie Davis", seed: 5, region: "New School" },
    { id: 18, name: "Tiffany Ervin", seed: 6, region: "New School" },
    { id: 19, name: "Genevieve Mushaluk", seed: 7, region: "New School" },
    { id: 20, name: "Kyle Fraser", seed: 8, region: "New School" },
    { id: 21, name: "Joe Hunter", seed: 9, region: "New School" },
    { id: 22, name: "Kamilla Karthigesu", seed: 10, region: "New School" },
    { id: 23, name: "Savannah Louie", seed: 11, region: "New School" },
    { id: 24, name: "Rizo Velovic", seed: 12, region: "New School" },
  ],
  // Added all 32 NFL teams for the 2026-2027 NFL Season tournament so its auction uses NFL teams per user request
  // Grouped by conference (AFC/NFC) with seeds ordered by division, matching the existing NFL team shape
  "nfl-season-2026-2027": [
    { id: 1, name: "Buffalo Bills", seed: 1, region: "AFC" },
    { id: 2, name: "Miami Dolphins", seed: 2, region: "AFC" },
    { id: 3, name: "New York Jets", seed: 3, region: "AFC" },
    { id: 4, name: "New England Patriots", seed: 4, region: "AFC" },
    { id: 5, name: "Baltimore Ravens", seed: 5, region: "AFC" },
    { id: 6, name: "Cincinnati Bengals", seed: 6, region: "AFC" },
    { id: 7, name: "Pittsburgh Steelers", seed: 7, region: "AFC" },
    { id: 8, name: "Cleveland Browns", seed: 8, region: "AFC" },
    { id: 9, name: "Houston Texans", seed: 9, region: "AFC" },
    { id: 10, name: "Indianapolis Colts", seed: 10, region: "AFC" },
    { id: 11, name: "Jacksonville Jaguars", seed: 11, region: "AFC" },
    { id: 12, name: "Tennessee Titans", seed: 12, region: "AFC" },
    { id: 13, name: "Kansas City Chiefs", seed: 13, region: "AFC" },
    { id: 14, name: "Los Angeles Chargers", seed: 14, region: "AFC" },
    { id: 15, name: "Denver Broncos", seed: 15, region: "AFC" },
    { id: 16, name: "Las Vegas Raiders", seed: 16, region: "AFC" },
    { id: 17, name: "Philadelphia Eagles", seed: 1, region: "NFC" },
    { id: 18, name: "Dallas Cowboys", seed: 2, region: "NFC" },
    { id: 19, name: "New York Giants", seed: 3, region: "NFC" },
    { id: 20, name: "Washington Commanders", seed: 4, region: "NFC" },
    { id: 21, name: "Detroit Lions", seed: 5, region: "NFC" },
    { id: 22, name: "Green Bay Packers", seed: 6, region: "NFC" },
    { id: 23, name: "Minnesota Vikings", seed: 7, region: "NFC" },
    { id: 24, name: "Chicago Bears", seed: 8, region: "NFC" },
    { id: 25, name: "Tampa Bay Buccaneers", seed: 9, region: "NFC" },
    { id: 26, name: "Atlanta Falcons", seed: 10, region: "NFC" },
    { id: 27, name: "New Orleans Saints", seed: 11, region: "NFC" },
    { id: 28, name: "Carolina Panthers", seed: 12, region: "NFC" },
    { id: 29, name: "San Francisco 49ers", seed: 13, region: "NFC" },
    { id: 30, name: "Seattle Seahawks", seed: 14, region: "NFC" },
    { id: 31, name: "Los Angeles Rams", seed: 15, region: "NFC" },
    { id: 32, name: "Arizona Cardinals", seed: 16, region: "NFC" },
  ],
  "stanley-cup-2025": [
